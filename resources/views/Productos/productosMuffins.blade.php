...
<div class="container text-center" id="productosTitulo">
    <h2 class="display-2 p-4">Muffins</h2>
...
<div class="container" id="contenedorProducto">
        <div class="row" id="fondo">
            @foreach ($muffins as $muf)   
            
            <div class ="col-md-4 col-xm-12 text-center" id="contenedor">
                <div class="card" id="tarjeta">
                    <div class="card-header">
                        <span class="" id="titulopastel">{{ $muf->nombre}}</span><br>
                    </div>
                    <div class="cardbody" id="descripcion">
                        <img src="images/{{ $muf->imagen}}" alt="" class="card-img-top img-fluid"  style="">
                        <span class="">Precio: ${{ $muf->precio}}</span>
                        <p class="card-text"><strong>Descripción: {{ $muf->descripcion}}</strong></p>
